...
PSP_MODULE_INFO("Whetstone VFPU", 0, 1, 1);//Aqui definimos el nombre del modulo, podemos poner el del programa
PSP_MAIN_THREAD_ATTR(PSP_THREAD_ATTR_USER | PSP_THREAD_ATTR_VFPU); // Aqui ponemos en que modo queremos que se ejecute, (peude ser en modo user o modo kernel)
...
// Funciones VFPU reemplazando las orignales de math.h
#define sin vfpu_sinf
#define cos vfpu_cosf
#define exp vfpu_expf
#define log vfpu_logf
#define atan vfpu_atanf
